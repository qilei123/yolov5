...
git pull
python val.py --weights /data/qilei/work_model_dirs/yolov5/trans_drone_cat3/yolov5s/exp_1280_mosaic4/weights/best.pt --data trans_drone_cat3.yaml --img 1280 --task test
