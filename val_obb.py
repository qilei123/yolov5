...
from models.ops import obb_nms,nms_rotated_ext
...
def run(data,
    ...
    for batch_i, (im, targets, paths, shapes, obb_targets) in enumerate(pbar):
        t1 = time_sync()
        ...
        #print(out.shape)
        print(single_cls)
        out = non_max_suppression_obb(out, conf_thres=0.25, iou_thres, labels=lb, multi_label=True, agnostic=single_cls)
