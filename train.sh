...
python train.py --img 1920 --batch 2 --epochs 64 --data trans_drone_cat3.yaml --weights yolov5x.pt --project /data/qilei/work_dir_models_results/yolov5/trans_drone_cat3/yolov5x --name exp_1920_mosaic4 #--mosaic_n False