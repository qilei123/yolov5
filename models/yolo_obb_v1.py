...
class ModelOBB(nn.Module):
    ...
    def _profile_one_layer(self, m, x, dt):
        c = isinstance(m, DetectOBBV1)  # is final layer, copy input as inplace fix
...
if __name__ == '__main__':
    ...
    # Create model
    model = ModelOBB(opt.cfg).to(device)
    model.train()
