...
python train_obb_v1.py \
        --img 1280 --batch 32 --epochs 128 --data trans_drone_cat3_v2.yaml \
        --weights yolov5s.pt --project $root_dir1/work_model_dirs/yolov5/trans_drone_cat5/yolov5s \
        --name exp_1280_mosaic4_obb_v1_train2 --exist-ok --device 0 \
        --hyp data/hyps/hyp.scratch_td.yaml --cfg models/yolov5s_obb_v1.yaml
#python train.py --img 1920 --batch 8 --epochs 64 --data trans_drone_cat3.yaml --weights yolov5s.pt --project /data3/qilei_chen/work_model_dirs/yolov5/trans_drone_cat3/yolov5s --name exp_1920_mosaic4
#python train.py --img 1920 --batch 8 --epochs 64 --data trans_drone_cat3.yaml --weights yolov5s.pt --project /data3/qilei_chen/work_model_dirs/yolov5/trans_drone_cat3/yolov5s --name exp_1920_mosaic4
