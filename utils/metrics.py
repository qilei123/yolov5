...
from models.ops.box_iou_rotated.box_iou_rotated_wrapper import obb_overlaps
import numpy as np
import torch
...
class ConfusionMatrixOBBV1:
    ...
    def process_batch(self, detections, labels):
        """
        Return intersection-over-union (Jaccard index) of boxes.
        Both sets of boxes are expected to be in (x1, y1, x2, y2, theta) format.
        Arguments:
...
class ConfusionMatrixOBB:
    ...
    def process_batch(self, detections, labels):
        ...
        #iou = box_iou(labels[:, 1:], detections[:, :5])
