...
python train_obb.py --exist-ok --device 0 --img 1280 --batch 32 --epochs 128 --hyp data/hyps/hyp.scratch_td.yaml --cfg models/yolov5s_obb.yaml --data trans_drone_cat3.yaml --weights yolov5s.pt --project $root_dir1/work_dir_models_results/yolov5/trans_drone_cat3_v2/yolov5s_obb --name exp_1280_mosaic4_debug --rect #--mosaic_n false
